...
const Experties = () => {
  return (
    <section className={css.wrapper}>
        <a className="anchor" id="apropos"></a>
        <motion.div
        ...
        className={`paddings yPaddings innerWidth flexCenter ${css.container}`}>
            ...
            className={css.rightSide}>
                ...
                <span className='primaryText'>Informations sur F.U.U.D</span>
                {WhatDoIHelp.map((paragraph, i)=> <span className='secondaryText' key={i}>{paragraph}</span>)}


                <div className={`flexCenter ${css.stats}`}>
                    <div className={`flexCenter ${css.stat}`}>
                        <span className='primaryText'>560</span>
                        <span className='secondaryText'>Étudiant / Lit</span>
                    </div>
                    <div className={`flexCenter ${css.stat}`}>
                        <span className='primaryText'>280</span>
                        <span className='secondaryText'>chambre</span>
                    </div>
                </div>
            </motion.div>
        </motion.div>
